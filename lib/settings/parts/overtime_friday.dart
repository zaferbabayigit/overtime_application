...
class OvertimeFriday extends StatefulWidget {
  OvertimeFriday({Key? key}) : super(key: key);

  @override
  State<OvertimeFriday> createState() => _OvertimeFridayState();
}

class _OvertimeFridayState extends State<OvertimeFriday> {
  @override
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(SettingsText.friday,
                      style: TextStyle(
