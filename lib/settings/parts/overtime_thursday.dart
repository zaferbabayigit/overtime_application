...
class OvertimeThursday extends StatefulWidget {
  OvertimeThursday({Key? key}) : super(key: key);

  @override
  State<OvertimeThursday> createState() => _OvertimeThursdayState();
}

class _OvertimeThursdayState extends State<OvertimeThursday> {
  @override
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(SettingsText.thursday,
                      style: TextStyle(
