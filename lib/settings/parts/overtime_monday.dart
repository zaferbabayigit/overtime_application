...
class OvertimeMonday extends StatefulWidget {
  OvertimeMonday({
    Key? key,
  });

  @override
  State<OvertimeMonday> createState() => _OvertimeMondayState();
}

class _OvertimeMondayState extends State<OvertimeMonday> {
  @override
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(SettingsText.monday,
                      style: TextStyle(
