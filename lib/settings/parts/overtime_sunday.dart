...
class OvertimeSunday extends StatefulWidget {
  OvertimeSunday({Key? key}) : super(key: key);

  @override
  State<OvertimeSunday> createState() => _OvertimeSundayState();
}

class _OvertimeSundayState extends State<OvertimeSunday> {
  @override
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(SettingsText.sunday,
                      style: TextStyle(
